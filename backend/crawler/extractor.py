...
def extract_signals(page: ParsedPage, links: List[Link]) -> PageSignals:
    """Builds PageSignals for one page and attaches any findings it implies."""
...
def _build_findings(s: PageSignals) -> List[Dict[str, Any]]:
    ...
    # Accessibility findings were removed along with the accessibility module.
    # Page signals are still collected above; no findings are raised here.
    return findings
