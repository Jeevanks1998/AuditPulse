...
_SAMPLE_FINDINGS = [
    ...
    },
    {
        "module": "analytics",
        "severity": "warning",
        "title": "Duplicate page-view tag",
        "description": "The GA4 page_view event fires twice on the homepage.",
    },
    {
        "module": "consent",
        "severity": "warning",
        "title": "Trackers load before consent",
        "description": "Marketing requests were observed before the visitor accepted cookies.",
    },
]
